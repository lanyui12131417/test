...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li   class="active"><a href="#"><i class="icon icon-file"></i> <span>文件上传</span></a>
    </li>
  </ul>
</div>
<!--sidebar-menu-->
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/page/teacherIndex.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a></div>
  </div>
<!--End-breadcrumbs-->
      ...
      <div class="widget-box">        
        <div class="widget-content" >
          ...
          <div class="widget-content nopadding">          			
          			<form action="${pageContext.request.contextPath}/uploadHttpOneServet" method="post" enctype="multipart/form-data">
