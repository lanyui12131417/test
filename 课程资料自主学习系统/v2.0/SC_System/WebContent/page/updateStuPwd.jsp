...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li><a href="${pageContext.request.contextPath}/showDownServlet"><i class="icon icon-th"></i> <span>文件下载</span></a>
    </li>
  </ul>
</div>
<!--sidebar-menu-->
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/page/stuIndex.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a></div>
  </div>
<!--End-breadcrumbs-->
