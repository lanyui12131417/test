...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    <li><a href="${pageContext.request.contextPath}/page/index.jsp"><i class="icon-home"></i> <span>首页</span></a> </li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th"></i> <span>新闻管理</span> </a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/page/addStu.jsp">新闻管理</a></li>
 		<li><a href="${pageContext.request.contextPath}/page/addSemester.jsp">添加新闻</a></li>
      </ul>
    </li>
  </ul>
</div>
