...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/page/index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">学生管理</a>  </div>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <c:forEach var="stu" items="${ stuList }">
              	<tr class="gradeX">
                  <td><center>${ stu.college }</center></td>
				  <td><center>${ stu.major }</center></td>
                  <td><center>${ stu.classes }</center></td>
                  <td><center>${ stu.number }</center></td>
				  <td><center>${ stu.name }</center></td>
				  <td><center>${ stu.sex }</center></td>
                  <td><center>${ stu.phone }</center></td>
                  <td>
                  <center>
                  	<a href="${pageContext.request.contextPath}/SearchStuServlet?number=${stu.number}"><button class="btn btn-info btn-mini">成绩</button></a>
                  	<a href="#"><button class="btn btn-warning btn-mini">修改</button></a>
                  	<a href="${pageContext.request.contextPath}/DelStuServlet?number=${stu.number}"><button class="btn btn-danger btn-mini">删除</button></a>
                  </center>
                  </td>
                </tr>
              </c:forEach>
