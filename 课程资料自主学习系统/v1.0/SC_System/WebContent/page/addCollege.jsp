...
<div id="content-header">
  <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/page/index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">添加</a> <a href="#" class="current">添加学生</a> </div>
    ...
    <div class="span6" style="margin-left:300px">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="${pageContext.request.contextPath}/InsertCollegeServlet" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">院号 :</label>
              <div class="controls">
                <input type="text" placeholder="" name="clno" />
              </div>
             </div>
            <div class="control-group">
              <label class="control-label">学院名 :</label>
              <div class="controls">
                <input type="text"  placeholder="" name="college" />
              </div>
             </div>
