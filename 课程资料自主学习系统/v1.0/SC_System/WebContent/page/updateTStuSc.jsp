...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    <li><a href="${pageContext.request.contextPath}/page/teacherIndex.jsp"><i class="icon icon-home"></i> <span>首页</span></a> </li>
    <li class="submenu"><a href="#"><i class="icon icon-th"></i> <span>成绩查询</span></a>
    	<ul>
    		<c:forEach var="tCourse" items="${sessionScope.thisTeaCoursesList}">
	       	 <li><a href="${pageContext.request.contextPath}/SearchSCServlet?username=${sessionScope.existUser.getUsername()}&cno=${tCourse.cno}">${tCourse.cname}</a></li>
	        </c:forEach>
      	</ul>
    </li>
 	<li class="submenu"><a href="#"><i class="icon icon-pencil"></i> <span>成绩录入</span></a>
    	<ul>
    		<c:forEach var="tCourse" items="${sessionScope.thisTeaCoursesList}">
	       	 <li><a href="${pageContext.request.contextPath}/GotoAddSCServlet?username=${sessionScope.existUser.getUsername()}&cno=${tCourse.cno}">${tCourse.cname}</a></li>
	        </c:forEach>
      	</ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/page/teacherIndex.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="${pageContext.request.contextPath}/SearchSCServlet?username=${sessionScope.existUser.getUsername()}&cno=${reqCno}" class="tip-bottom">成绩查询</a> <a href="#" class="tip-bottom">成绩修改</a> </div>
  </div>
<!--End-breadcrumbs-->
    ...
    <div class="span6" style="margin-left:300px">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">        
            <form action="${pageContext.request.contextPath}/UpdateThisSCServlet" method="post" class="form-horizontal">
			...
			<a href="${pageContext.request.contextPath}/SearchSCServlet?username=${sessionScope.existUser.getUsername()}&cno=${reqCno}">
            <button type="button" class="btn btn-warning"  style="margin-left:220px">返回</button>
             </a>
