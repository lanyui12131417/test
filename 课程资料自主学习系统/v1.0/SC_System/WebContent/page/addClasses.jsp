    ...
    <div class="span6" style="margin-left:300px">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="${pageContext.request.contextPath}/InsertClassesServlet" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">班级名 :</label>
              <div class="controls">
                <input type="text"  placeholder="" name="classes" />
              </div>
           </div>
           <div class="control-group">
              <label class="control-label">所属学院 :</label>
              <div class="controls">
                <input type="text"  placeholder="" name="clcollege" />
              </div>
           </div>
