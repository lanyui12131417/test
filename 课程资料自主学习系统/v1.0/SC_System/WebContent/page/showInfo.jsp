...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    <li ><a href="${pageContext.request.contextPath}/SearchStuServlet"><i class="icon icon-home"></i> <span>首页</span></a> </li>
    <li class="active"><a ><i class="icon icon-th"></i> <span>文件下载</span></a>
    </li>
  </ul>
</div>
<!--sidebar-menu-->
