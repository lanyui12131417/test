...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li><a href="${pageContext.request.contextPath}/SearchStuServlet?number=${ sessionScope.existUser.getUsername() }&col=stu"><i class="icon icon-th"></i> <span>成绩查询</span></a>
    </li>
  </ul>
</div>
<!--sidebar-menu-->
      ...
      <div class="widget-box">        
        <div class="widget-content" >
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <form action="${pageContext.request.contextPath}/StuUpdateServlet" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">学院 :</label>
              <div class="controls">
                <input type="text"  value="${sessionScope.existStu.getCollege()}" name="college" readonly="readonly" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">专业 :</label>
              <div class="controls">
                <input type="text"  value="${sessionScope.existStu.getMajor()}" name="major" readonly="readonly" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">班级 :</label>
              <div class="controls">
                <input type="text"  value="${sessionScope.existStu.getClasses()}" name="classes" readonly="readonly" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">学号 :</label>
              <div class="controls">
                <input type="text"  value="${sessionScope.existStu.getNumber()}" name="number" readonly="readonly"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="${sessionScope.existStu.getName()}" name="name" />
              </div>
            </div>
			<div class="control-group">
              ...
              <div class="controls">
                <label>
                <c:if test="${sessionScope.existStu.getSex() eq '男'}">
                ...
                <label>
				 ...
				 <c:if test="${sessionScope.existStu.getSex() eq '女'}">
			...
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text"  value="${sessionScope.existStu.getPhone()}" name="phone" />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" style="margin-left:250px">修改</button>
            </div>
          </form>
          </div>  
        </div>
