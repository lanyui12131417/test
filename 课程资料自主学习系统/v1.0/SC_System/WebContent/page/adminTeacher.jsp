  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">欢迎 ${sessionScope.existUser.getPosition()} </span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        ...
        <li class="divider"></li>
        <li><a href="#"><i class="icon icon-share-alt"></i> 退出</a></li>
      </ul>
    </li>
  </ul>
</div>
...
<!--start-top-serch-->
<div id="search">
  <a title="" href="${pageContext.request.contextPath}/LoginOutServlet"><i class="icon icon-share-alt"></i> <span class="text">退出</span></a>
</div>
<!--sidebar-menu-->
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li class="active"><a href="${pageContext.request.contextPath}/adminTeacherServlet"><i class="icon icon-th"></i> <span>教师管理</span></a></li>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <c:forEach var="teacher" items="${ teacherList }">
              	<tr class="gradeX">
                  <td><center>${ teacher.college }</center></td>
				  <td><center>${ teacher.number }</center></td>
                  <td><center>${ teacher.name }</center></td>
                  <td><center>${ teacher.sex }</center></td>
                  <td><center>${ teacher.phone }</center></td>
                  <td>
                  <center>                  	
                  	<a href="#"><button class="btn btn-warning btn-mini">修改</button></a>
                  	<a href="${pageContext.request.contextPath}/DelTeacherServlet?number=${teacher.number}" onclick="return confirm('确定删除？');"><button class="btn btn-danger btn-mini">删除</button></a>
                  </center>
                  </td>
                </tr>
              </c:forEach>
