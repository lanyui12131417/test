...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li  class="active"><a href="#"><i class="icon icon-pencil"></i> <span>成绩审核</span></a></li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              <c:forEach var="sc" items="${ flagSCList }">
              	<c:if test="${ sc.flag eq '审核中' }">
              	<tr class="gradeX">
                  ...
                  <td>
                  <center>                  	
                  	<a href="${pageContext.request.contextPath}/PassSCServlet?number=${sc.number}&cname=${sc.cname}&semester=${sc.semester}"><button class="btn btn-success btn-mini">通过</button></a>
                  	<a href="${pageContext.request.contextPath}/RejectFlagSCServlet?number=${sc.number}&cname=${sc.cname}&semester=${sc.semester}" onclick="return confirm('确定驳回？');"><button class="btn btn-danger btn-mini">驳回</button></a>
                  </center>
                  </td>
                </tr>
                </c:if>
