...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li class="active"><a href="#"><i class="icon icon-pencil"></i> <span>添加课程</span></a>
    </li>
    ...
    <div class="row-fluid">
      <div class="widget-box">        
        ...
        <div class="widget-content nopadding">
            <form action="${pageContext.request.contextPath}/InsertCourseServlet" class="form-horizontal" method="post" name="password_validate" id="password_validate" novalidate="novalidate" >
		            <div class="control-group">
		              <label class="control-label">课程名:</label>
		              <div class="controls">
		                <input type="text" width="300px" placeholder="" name="cname" />
		              </div>
		            </div>
		            <div class="control-group">
		              <label class="control-label">授课教师:</label>
		              <div class="controls">
		                <input type="text" width="300px" placeholder="" name="teacher" />
		              </div>
		            </div>
		            <div class="control-group">
		              <label class="control-label">授课学期:</label>
		              <div class="controls" >
		                <input type="text" width="300px" height="500px" placeholder="" name="semester" />
		              </div>
		            </div>
